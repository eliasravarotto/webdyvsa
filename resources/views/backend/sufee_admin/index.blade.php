...
<body>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="#">Saenz Peña</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="#">Resistencia</a></li>
                            <li><i class="menu-icon ti-themify-logo"></i><a href="#">Charata</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-line-chart"></i><a href="charts-chartjs.html">Facebook</a></li>
                            <li><i class="menu-icon fa fa-area-chart"></i><a href="charts-flot.html">Twitter</a></li>
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-message">
                          ...
                          <div class="dropdown-menu" aria-labelledby="message">
                            ...
                            <a class="dropdown-item media bg-flat-color-1" href="#">
                                <span class="photo media-left"><img alt="avatar" src="/imagenes/sfee_admin/images/avatar/1.jpg"></span>
                            ...
                            <a class="dropdown-item media bg-flat-color-4" href="#">
                                <span class="photo media-left"><img alt="avatar" src="/imagenes/sfee_admin/images/avatar/2.jpg"></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-5" href="#">
                                <span class="photo media-left"><img alt="avatar" src="/imagenes/sfee_admin/images/avatar/3.jpg"></span>
                                <span class="message media-body">
                            ...
                            <a class="dropdown-item media bg-flat-color-3" href="#">
                                <span class="photo media-left"><img alt="avatar" src="/imagenes/sfee_admin/images/avatar/4.jpg"></span>
                                <span class="message media-body">
    ...
    {{-- <script src="/sfee_admin/assets/js/vendor/jquery-2.1.4.min.js"></script> --}}
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.12.3/umd/popper.min.js"></script>
    <script src="/sfee_admin/assets/js/plugins.js"></script>

    {{-- <script src="/sfee_admin/assets/js/main.js"></script> --}}

    <script src="/sfee_admin/assets/js/lib/chart-js/Chart.bundle.js"></script>
    <script src="/sfee_admin/assets/js/dashboard.js"></script>
    <script src="/sfee_admin/assets/js/widgets.js"></script>
    {{-- <script src="/sfee_admin/assets/js/lib/vector-map/jquery.vmap.js"></script>
    <script src="/sfee_admin/assets/js/lib/vector-map/jquery.vmap.min.js"></script>
