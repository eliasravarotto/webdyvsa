<footer>
	<section class="section-colored text-center prefooter " style="padding: 20px 0; background-color: #f5f5f5; margin-top: 25px;">
		<div class="container">
		<div class="row">
	...
	<section class="footer" style="background-color: #58595b">
		...
		<div class="row py-2">
			...
			{{-- <div class="col-md-2 col-sm-12">
				<h3 class="title-footer">MODELOS</h3>
				<ul class="list-unstyled ml-1 ul-footer-modelo">
					@foreach(\App\Helpers\Helper::getModelos() as $modelo)
					<li><a href="#" title="">{{$modelo->nombre}}</a></li>
					@endforeach
				</ul>
			</div> --}}
